;(function() {
  ...
  var localizations = {
    'en-US': {
      ...
      'ACCOUNT_FORM->REQUIRED_ERROR': function(it) {
        var string = '';
        string += 'Error: field is required';
        return string;
      },
      'ACCOUNTS_LIST->SAVE_ACCOUNTS': function(it) {
        var string = '';
        string += 'Save';
        return string;
      },
      'ACCOUNTS_LIST->ADD_ACCOUNT_LINK': function(it) {
        var string = '';
        string += 'Add account';
        return string;
      },
      'ACCOUNT_FORM->DELETE_LINK': function(it) {
        var string = '';
        string += 'Delete';
        return string;
      },
      'ACCOUNT_FORM->HEADER': function(it) {
        var string = '';
        string += 'Account';
        return string;
      },
      'ACCOUNT_FORM->BIC': function(it) {
        var string = '';
        string += 'BIC';
        return string;
      },
      'ACCOUNT_FORM->IBAN': function(it) {
        var string = '';
        string += 'IBAN';
        return string;
      },
      'ACCOUNTS_FORM->NOT_FOUND_USER_HEADER': function(it) {
        var string = '';
        string += 'Not found user';
        return string;
      },
      'ACCOUNTS_FORM->USER_HEADER': function(it) {
        var string = '';
        string += 'Accounts ';
        string += it.firstName;
        string += ' ';
        string += it.middleName;
        string += ' ';
        string += it.lastName;
        return string;
      },
      'USER_FORM->LINK_TO_ACCOUNT': function(it) {
        var string = '';
        string += 'Accounts';
        return string;
      },
      'USER_FORM->UPDATE_BUTTON': function(it) {
        var string = '';
        string += 'Update';
        return string;
      },
      'USER_FORM->CHANGE_USER_HEADER': function(it) {
        var string = '';
        string += 'User ';
        string += it.firstName;
        string += ' ';
      ...
      'USER_FORM->NOT_FOUND_USER_HEADER': function(it) {
        var string = '';
        string += 'Not found user';
        return string;
      },
      'USER_FORM->INVALID_ERROR': function(it) {
        var string = '';
        string += 'Error: incorrect format';
        return string;
      },
      'USER_FORM->REQUIRED_ERROR': function(it) {
        var string = '';
        string += 'Error: field is required';
        return string;
      },
      'USERS_LIST->USERS_COUNT': function(it) {
        var string = '';
        var _case;
        if(it.count === 0) {
          _case = '=' + (0);
          ...
          _case = this.__getPluralKeyword(it.count);
        }
        switch(_case) {
          case '=0':
            string += 'No such users';
            break;
          case 'one':
            string += 'One user';
            break;
      ...
      'USERS_LIST->HEADER': function(it) {
        var string = '';
        string += 'Users list';
        return string;
      },
      'USERS_LIST->CHANGE_LINK': function(it) {
        var string = '';
        string += 'Change';
        return string;
      },
      'USERS_LIST->DELETE_LINK': function(it) {
        var string = '';
        string += 'Delete';
        return string;
      },
      'USERS_LIST->DELETE_USER': function(it) {
        var string = '';

        return string;
      },
      'USERS_LIST->SELECT_USER': function(it) {
        var string = '';

        return string;
      },
      'USER_FORM->FIRST_NAME': function(it) {
        var string = '';
        string += 'First name';
        return string;
      },
      'USER_FORM->LAST_NAME': function(it) {
        var string = '';
        string += 'Last name';
        return string;
      },
      'USER_FORM->MIDDLE_NAME': function(it) {
        var string = '';
        string += 'Middle name';
        return string;
      },
      'USER_FORM->ADD_BUTTON': function(it) {
        var string = '';
        string += 'Add';
        return string;
      },
      'USER_FORM->ADD_USER_HEADER': function(it) {
        var string = '';
        string += 'Add user';
        return string;
      },
      'MAIN->CHANGE_LANGUAGE': function(it) {
        var string = '';
    ...
    'ru-RU': {
      '__getPluralKeyword': function(cardinal) {
        ...
        else if(v === 0 && (2 >= i && i <= 4) && (12 >= i && i <= 14)) {
          return 'few';
        }
        else if(v === 0 && i % 10 === 0 || v === 0 && (5 >= i && i <= 9) || v === 0 && (11 >= i && i <= 14)) {
          return 'many';
        }
        return 'other';
      },
      ...
      'ACCOUNT_FORM->REQUIRED_ERROR': function(it) {
        var string = '';
        string += 'Ошибка: поле, обязательное для заполнения';
        return string;
      },
      'ACCOUNTS_LIST->SAVE_ACCOUNTS': function(it) {
        var string = '';
      ...
      'USER_FORM->ADD_USER_HEADER': function(it) {
        var string = '';
        string += 'Добавить пользователя';
        return string;
      },
      'MAIN->CHANGE_LANGUAGE': function(it) {
        var string = '';
        string += 'Изменить язык';
        return string;
      }
    }
  };
